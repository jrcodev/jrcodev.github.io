...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
strings:i,keywords:u}}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
},{className:"string",begin:/'/,end:/'/},n]}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
...
}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
